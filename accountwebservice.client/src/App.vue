<template>
  <div class="row">
    <h2>
      Учетные записи
      <button id="account-add" type="button" class="btn btn-info" @click="accountStore.addAccount()">
  ...
  <div class="row">
    <div id="label-alert" class="alert alert-primary w-100" role="alert">
  ...
  <div class="row">
    <table class="table accounts-table">
      ...
      <tbody class="accounts">
        <Account v-for="account of accountStore.accounts" :key="account.id" :account="account" />
      </tbody>
    </table>
  </div>
</template>
